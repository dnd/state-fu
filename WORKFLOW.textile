...
So could StateFu model the workflow patterns presented here?
...
________________________________________________________________________
2. Parallel Split / Concurrence / Fork
...
________________________________________________________________________
3. Synchronization( AND-join, rendezvous, synchronizer )

I think the discussion above pretty much covers it.
________________________________________________________________________
4. Exclusive Choice ( OR )
...
________________________________________________________________________
5. Simple merge (XOR-join, exclusive OR-join, asynchronous join,
merge)
